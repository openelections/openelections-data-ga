...
-- Load JSON data...
-----------------------------------------------------------------------------------------------
create or replace table raw.jul2025_psc_special_runoff_election_county
as
select *
from read_json(
    '/Users/skunkworks/Development/openelections-data-ga/2025/code/ga_20250715_county_level_data.json',
    format = 'auto',
    columns = {
...
select *
from raw.jul2025_psc_special_runoff_election_county;
...
-- update raw.jul2025_psc_special_runoff_election_county
--     set vote_type =
--         case
...
-----------------------------------------------------------------------------------------------
-- create or replace table stage.jul2025_psc_special_runoff_election_county
-- as
-- pivot raw.jul2025_psc_special_runoff_election_county
-- on vote_type
-- using sum(votes);
...
select *
from stage.jul2025_psc_special_runoff_election_county;
...
alter table stage.jul2025_psc_special_runoff_election_county
    add column original_office varchar;

update stage.jul2025_psc_special_runoff_election_county
...
------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------
delete from stage.jul2025_psc_special_runoff_election_county
where office != 'Public Service Commissioner';
...
-----------------------------------------------------------------------------------------------
create or replace table prod.jul2025_psc_special_runoff_election_county
as
select *
from stage.jul2025_psc_special_runoff_election_county
...
select *
from prod.jul2025_psc_special_runoff_election_county;
...
update prod.jul2025_psc_special_runoff_election_county
...
(
    ...
    from prod.jul2025_psc_special_runoff_election_county
    order by county, office, try_cast(district as integer), party, candidate   
) to '/Users/skunkworks/Development/openelections-data-ga/2025/20250715__ga__special__runoff__psc__county-level.csv'
(HEADER, DELIMITER ',');
