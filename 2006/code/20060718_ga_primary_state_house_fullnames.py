...
html = urlopen("http://sos.ga.gov/elections/election_results/2006_0718/house.htm") # noqa
bs = BeautifulSoup(html.read(), "lxml")

SQL = """
INSERT INTO ga_primary_state_house_20060718_fullnames
...
for counter, name in enumerate(names):
    ...
    district_info = districts[counter].get_text().replace("STATE REPRESENTATIVE - ", "") # noqa
