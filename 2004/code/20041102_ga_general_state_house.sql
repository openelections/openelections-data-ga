truncate table ga_general_state_house_20041102_fullnames;

CREATE TABLE ga_general_state_house_20041102_fullnames
  (
    name varchar(50),
...
-- 20041102_ga_general_state_house_fullnames.py

select *
from ga_general_state_house_20041102_fullnames;

-- Clean up some name issues and then split out the
-- last name. Finally we fix a few last names that
-- didn't parse out correctly...
update ga_general_state_house_20041102_fullnames
...
---------------------------------------------------------
---------------------------------------------------------
truncate table ga_general_state_house_20041102_county_votes;

CREATE TABLE ga_general_state_house_20041102_county_votes
  (
    last_name varchar(50),
    party varchar(50),
...
-- Run Python script here...
-- 20040720_ga_general_state_house_county_votes.py

select *
from ga_general_state_house_20041102_county_votes;

update ga_general_state_house_20041102_county_votes
...
select *
from ga_general_state_house_20041102_fullnames as a
  left join ga_general_state_house_20041102_county_votes as b
...
select *
from ga_general_state_house_20041102_county_votes as a
  left join ga_general_state_house_20041102_fullnames as b
    on a.last_name = b.last_name
      and a.district_number = b.district_number
      and a.party = b.party
where b.last_name is null;
...
from ga_general_state_house_20041102_fullnames as a
  inner join ga_general_state_house_20041102_county_votes as b
    on a.last_name = b.last_name
      and a.district_number = b.district_number
      and a.party = b.party
