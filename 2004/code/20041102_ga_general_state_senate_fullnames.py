...
html = urlopen("http://sos.ga.gov/elections/election_results/2004_1102/senate.htm")

bs = BeautifulSoup(html.read(), "lxml")

SQL = """
INSERT INTO ga_primary_state_senate_20041102_fullnames
...
for counter, name in enumerate(names):
    ...
    for line in name_parts:
        name = line[:21]
        party = line[21:24]
        votes = line[25:40].replace(',', '').replace(' ', '')
        percent = line[40:].replace(' ', '')
