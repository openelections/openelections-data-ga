truncate table ga_general_state_senate_20041102_fullnames;

CREATE TABLE ga_general_state_senate_20041102_fullnames
  (
    name varchar(50),
...
select *
from ga_general_state_senate_20041102_fullnames
...
update ga_general_state_senate_20041102_fullnames
...
where rtrim(name) = 'MICHAEL VON BREMEN';
...
truncate table ga_general_state_senate_20041102_county_votes;

CREATE TABLE ga_general_state_senate_20041102_county_votes
  (
    last_name varchar(50),
    party varchar(50),
...
select *
from ga_general_state_senate_20041102_county_votes
...
update ga_general_state_senate_20041102_county_votes
...
select *
from ga_general_state_senate_20041102_fullnames as a
  left join ga_general_state_senate_20041102_county_votes as b
...
select *
from ga_general_state_senate_20041102_county_votes as a
  left join ga_general_state_senate_20041102_fullnames as b
    on a.last_name = b.last_name
      and a.district_number = b.district_number
      and a.party = b.party
where b.last_name is null;
...
from ga_general_state_senate_20041102_fullnames as a
  inner join ga_general_state_senate_20041102_county_votes as b
    on a.last_name = b.last_name
      and a.district_number = b.district_number
      and a.party = b.party
