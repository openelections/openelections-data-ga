truncate table ga_primary_runoff_state_house_20040810_fullnames;

CREATE TABLE ga_primary_runoff_state_house_20040810_fullnames
  (
    name varchar(50),
...
---------------------------------------------------------
---------------------------------------------------------
truncate table ga_primary_runoff_state_house_20040810_county_votes;

CREATE TABLE ga_primary_runoff_state_house_20040810_county_votes
  (
    last_name varchar(50),
    party varchar(50),
...
select *
from ga_primary_runoff_state_house_20040810_county_votes;

update ga_primary_runoff_state_house_20040810_county_votes
...
select *
from ga_primary_runoff_state_house_20040810_fullnames as a
  left join ga_primary_runoff_state_house_20040810_county_votes as b
...
select *
from ga_primary_runoff_state_house_20040810_county_votes as a
  left join ga_primary_runoff_state_house_20040810_fullnames as b
    on a.last_name = b.last_name
      and a.district_number = b.district_number
      and a.party = b.party
where b.last_name is null;
...
from ga_primary_runoff_state_house_20040810_fullnames as a
  inner join ga_primary_runoff_state_house_20040810_county_votes as b
    on a.last_name = b.last_name
      and a.district_number = b.district_number
      and a.party = b.party
