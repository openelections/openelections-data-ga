WITH precinct_agg AS (
    ...
    FROM read_csv_auto('/Users/skunkworks/Development/openelections-data-ga/2014/20140107__ga__special__state__house__2__22__precinct-level.csv')
...
county_level AS (
    ...
    FROM read_csv_auto('/Users/skunkworks/Development/openelections-data-ga/2014/20140107__ga__special__state__house__2__22__county-level.csv')
)
SELECT 
    c.county,
    c.office,
...
FROM county_level c
FULL OUTER JOIN precinct_agg p
...
WHERE 
    ...
    COALESCE(c.c_provisional, 0) <> COALESCE(p.p_provisional, 0);
