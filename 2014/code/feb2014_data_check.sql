WITH precinct_agg AS (
    ...
    FROM read_csv_auto('/Users/skunkworks/Development/openelections-data-ga/2014/20140204__ga__special__state__house__2__22__runoff__precinct-level.csv')
...
county_level AS (
    ...
    FROM read_csv_auto('/Users/skunkworks/Development/openelections-data-ga/2014/20140204__ga__special__state__house__2__22__runoff__county-level.csv')
)
SELECT 
    c.county,
    c.office,
